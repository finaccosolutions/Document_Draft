        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400">
              Create professional documents in minutes with our intuitive document generation platform.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/documents" className="text-gray-400 hover:text-white transition-colors duration-200">
                  Templates
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-gray-400">123 Document Street, Template City</span>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@docugen.com" className="text-gray-400 hover:text-white transition-colors duration-200">
                  info@docugen.com
                </a>
              </li>
            </ul>
